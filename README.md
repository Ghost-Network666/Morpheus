...
| Platform | Download |
|---|---|
| **Windows** (x64, installer) | [⬇ morpheus-1.0.0-setup.exe](https://github.com/Ghost-Network666/Morpheus/releases/download/v1.0.0/morpheus-1.0.0-setup.exe) |
| **Windows** (x64, portable) | [⬇ morpheus-1.0.0-x64.exe](https://github.com/Ghost-Network666/Morpheus/releases/download/v1.0.0/morpheus-1.0.0-x64.exe) |
| **macOS** (Apple Silicon) | [⬇ morpheus-1.0.0-arm64.dmg](https://github.com/Ghost-Network666/Morpheus/releases/download/v1.0.0/morpheus-1.0.0-arm64.dmg) |
| **macOS** (Intel x64) | [⬇ morpheus-1.0.0-x64.dmg](https://github.com/Ghost-Network666/Morpheus/releases/download/v1.0.0/morpheus-1.0.0-x64.dmg) |
